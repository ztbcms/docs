...
* [模板](guide/template/README.md)
    * [模板标签](guide/template/tag/README.md)
        ...
        * [tags内容标签](guide/template/tag/tags.md)
        * [comment评论标签](guide/template/tag/comment.md)
        * [position推荐位标签](guide/template/tag/position.md)
        * [get数据获取标签](guide/template/tag/get.md)
        * [template模板引入标签](guide/template/tag/template.md)
        * [navigate导航标签](guide/template/tag/navigate.md)
...
* [商城](module/shop/README.md)
    * [用户管理](module/shop/user/README.md)
        * [用户注册](module/shop/user/user_register.md)
        * [用户登录](module/shop/user/user_login.md)
    ...
    * [购物车管理](module/shop/cart/README.md)
        ...
        * [购物车列表](module/shop/cart/cart_list.md)
        * [设置购物车数量](module/shop/cart/cart_set.md)
    * [订单管理](module/shop/order/README.md)
        * [订单列表](module/shop/order/order_list.md)
        * [订单详情](module/shop/order/order_detail.md)
        * [创建订单](module/shop/order/order_create.md)
    * [商品](module/shop/goods/README.md)
        * [商品列表](module/shop/goods/goods_list.md)
...
* [开发Tips汇总](best_practic/dev_tips.md)
    ...
    * [根据管理员的权限显示](best_practic/tips/rbac.md)
